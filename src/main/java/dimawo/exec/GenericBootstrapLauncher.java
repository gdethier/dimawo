...
public class GenericBootstrapLauncher {
	...
	public static void main(String[] args) throws Exception {
		...
		params.maxNumOfChildren = Integer.parseInt(args[3]);
		params.reliabilityThreshold = Integer.parseInt(args[4]);
		params.verbLevel = Integer.parseInt(args[5]);
