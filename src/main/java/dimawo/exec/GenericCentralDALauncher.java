...
public class GenericCentralDALauncher {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length < nGenArgs) {
      System.out
          .println("Usage: <fact. class> <port> <working dir.> <ctrl host> <ctrl port> ...");
      System.exit(-1);
    }
    ...
    MasterWorkerFactory tFact = (MasterWorkerFactory) Reflection
        .newInstance(factClassName);
    ...
    DistributedAgent da = new DistributedAgent(id, workDirName, tFact,
        new NullDiscoveryService(), new ConsoleLogger(),
