...
public class TestErrorMessage extends Message implements ErrorMessage {

	private static final long serialVersionUID = 1L;
	private String msg;
	private String fileUID;

	public TestErrorMessage(String msg, String fileUID) {
		this.msg = msg;
		this.fileUID = fileUID;
	}
	
	public TestErrorMessage(String string) {
		this.msg = string;
	}
