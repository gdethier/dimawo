...
public class FileDownloaderMessage extends FileSystemMessage {

	private static final long serialVersionUID = 1L;
	
	private Object handId;
	
	public FileDownloaderMessage() {
	}

	public FileDownloaderMessage(DAId t) {
		super(t);
	...
	public static Object getHandlerId(DAId destId) {
		return "FileDownloaderMessage_"+destId;
	}
}
