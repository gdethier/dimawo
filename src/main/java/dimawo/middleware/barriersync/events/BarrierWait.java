 ...
 * #L%
 */
package dimawo.middleware.barriersync.events;
...
public class BarrierWait {
	...
	public BarrierWait(BarrierID id, BarrierSyncCallBackInterface cb) {
		this.id = id;
		this.cb = cb;
	}
	...
	public BarrierSyncCallBackInterface getCallBackInterface() {
		return cb;
	}
