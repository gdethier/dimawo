...
public class CentralTableCallMessage extends MasterMessage implements SharedMapAgentMessage {
	...
	public CentralTableCallMessage(DAId sourceDaId, AsynchronousCall call) {
		super(sourceDaId);
		this.call = call;
	}
