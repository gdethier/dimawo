...
public class CentralTableCallBackMessage extends Message implements SharedMapAgentMessage {

	private static final long serialVersionUID = 1L;
	private AsynchronousCall call;


	public CentralTableCallBackMessage(DAId daId, AsynchronousCall call) {
		super(daId);
		this.call = call;
	}
