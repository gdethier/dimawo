...
public interface OverlayAgentInterface {
	public void setJoinParameters(JoinParameters params) throws OverlayException;
	...
	public void registerForMnTreeUpdates(MnTreeLocalUpdateCallBackInterface cbInt);
}
