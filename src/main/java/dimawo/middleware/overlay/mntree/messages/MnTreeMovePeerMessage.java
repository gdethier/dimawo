...
public class MnTreeMovePeerMessage extends MnTreeMessage {
	private static final long serialVersionUID = 1L;
	
	private MnPeerState newState;

	public MnTreeMovePeerMessage(DAId daTo, MnId from, MnId to, MnPeerState newState) {
		super(daTo, from, to);
