...
public class FirstStageMessage extends MnTreeMessage
implements ReliableForwarderMessage {
	private MessageId msgId;
	private ForwardType type;
	private Message m;

	public FirstStageMessage(DAId daTo, MnId mnFrom, MnId mnTo, MessageId msgId, ForwardType type, Message m) {
