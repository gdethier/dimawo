...
public class ThirdStageMessage extends MnTreeMessage implements
		ReliableForwarderMessage {
	
	private SecondStageMessageInfo info;

	public ThirdStageMessage(DAId daTo, MnId from, MnId to,
			SecondStageMessageInfo info) {
		super(daTo, from, to);
		this.info = info;
	}

	public SecondStageMessageInfo getMessageInfo() {
		return info;
	}
}
