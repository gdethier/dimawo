...
public class RemoveDataEntryResultMessage extends ChordAgentMessage implements
		CallStateMessage {
	private static final long serialVersionUID = 1L;
	private String key;
	private boolean isRoutingError;

	public RemoveDataEntryResultMessage(DAId to, ChordId chordFrom,
			ChordId chordTo, String key, boolean isRoutingError) {
