...
public class SetSuccessorsMessage extends ChordAgentMessage {
	private static final long serialVersionUID = 1L;
	
	private LinkedList<ChordTableEntry> succs;

	public SetSuccessorsMessage(DAId to, ChordId chordFrom, ChordId chordTo,
			LinkedList<ChordTableEntry> succs) {
