...
public class SetDataMessage extends ChordAgentMessage {
	private LinkedList<SharedMapEntry> content;

	public SetDataMessage(DAId to, ChordId chordFrom, ChordId chordTo,
			LinkedList<SharedMapEntry> content) {
