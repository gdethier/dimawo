...
public class ChordJoinMessage extends ChordAgentMessage {

	public ChordJoinMessage(DAId to, ChordTableEntry thisEntry) {
		super(to, thisEntry.getChordId(), new ChordId(to));
	}
